...
var app = (function () {
    ...
    */
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(canvas, file$1, 42, 0, 789);
    		},
    ...
    class Base extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$3, create_fragment$3, safe_not_equal, { data: 2, type: 3, options: 4, plugins: 5 });
    ...
    class Chart extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$1, create_fragment$1, safe_not_equal, { countriesInfo: 2 });
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h10, file, 11, 8, 204);
    			attr_dev(div0, "class", "col");
    			add_location(div0, file, 10, 6, 178);
    			attr_dev(div1, "class", "row mt-5");
    			add_location(div1, file, 9, 4, 149);
    			attr_dev(div2, "class", "container");
    			add_location(div2, file, 8, 0, 121);
    			set_style(div3, "width", "50%");
    			add_location(div3, file, 15, 2, 282);
    			add_location(h11, file, 18, 0, 345);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ name, Chart, commonProps });
